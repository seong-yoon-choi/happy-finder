...
const initialItems = [
  {
    id: 'h21',
    title: '일기 쓰기',
    description: '하루 끝에 몇 줄 적고 다시 읽어보면 오늘을 잘 지나온 느낌이 들어요.',
    previewImage: '/happiness-list/h21.png',
    category: '소확행',
    isCustom: false,
    creator: 'system',
    totalEnjoyCount: 12
  },
  {
    id: 'h22',
    title: '좋아하는 양말 신기',
    description: '아침에 작은 취향을 고르면 하루를 내 방식으로 시작하는 기분이 들어요.',
    previewImage: '/happiness-list/h22.png',
    category: '소확행',
    isCustom: false,
    creator: 'system',
    totalEnjoyCount: 9
  },
  {
    id: 'h23',
    title: '나에게 칭찬 한마디 하기',
    description: '짧은 칭찬 한마디가 하루를 시작하기 전 내 편을 만든 느낌을 줘요.',
    previewImage: '/happiness-list/h23.png',
    category: '소확행',
    isCustom: false,
    creator: 'system',
    totalEnjoyCount: 11
  },
  {
    id: 'h24',
    title: '휴대폰 배경화면 바꾸기',
    description: '자주 보는 화면을 바꾸면 큰 노력 없이도 하루 중 작은 환기가 생겨요.',
    category: '소확행',
    isCustom: false,
    creator: 'system',
    totalEnjoyCount: 10
  },
  {
    id: 'h25',
    title: '빗소리 듣기',
    description: '비 오는 날 음악을 끄고 빗소리에 집중하면 마음이 천천히 차분해져요.',
    category: '소확행',
    isCustom: false,
    creator: 'system',
    totalEnjoyCount: 8
  },
  {
    id: 'h26',
    title: '핸드크림 향 맡기',
    description: '손에 남은 향을 천천히 맡으면 바쁜 중에도 잠깐 나를 챙긴 느낌이 들어요.',
    category: '소확행',
    isCustom: false,
    creator: 'system',
    totalEnjoyCount: 13
  },
  {
    id: 'h27',
    title: '입고 싶던 옷 고르기',
    description: '마음에 드는 옷을 고르면 다음 외출을 기다리는 작은 설렘이 생겨요.',
    category: '기분전환',
    isCustom: false,
    creator: 'system',
    totalEnjoyCount: 10
  },
  {
    id: 'h28',
    title: '미뤄둔 영화 보기',
    description: '보고 싶던 영화를 틀면 잠깐 다른 세계에 다녀온 듯 머리가 환기돼요.',
    category: '기분전환',
    isCustom: false,
    creator: 'system',
    totalEnjoyCount: 14
  },
  {
    id: 'h29',
    title: '노래방에서 노래 부르기',
    description: '잘 부르려 하지 않고 크게 부르면 답답한 감정이 시원하게 풀려요.',
    category: '기분전환',
    isCustom: false,
    creator: 'system',
    totalEnjoyCount: 9
  },
  {
    id: 'h30',
    title: '쉬는 날 계획하기',
    description: '쉬는 날 하고 싶은 일을 적어두면 그날이 오기 전부터 기다리는 재미가 생겨요.',
    category: '기분전환',
    isCustom: false,
    creator: 'system',
    totalEnjoyCount: 7
  },
  {
    id: 'h31',
    title: '서점에서 책 구경하기',
    description: '책을 사지 않아도 표지와 제목을 둘러보면 지금 끌리는 마음이 보여요.',
    category: '기분전환',
    isCustom: false,
    creator: 'system',
    totalEnjoyCount: 8
  },
  {
    id: 'h32',
    title: '오래 고민한 물건 사기',
    description: '충분히 고민한 물건을 사면 내 필요와 취향을 인정해준 느낌이 들어요.',
    category: '기분전환',
    isCustom: false,
    creator: 'system',
    totalEnjoyCount: 11
  },
  {
    id: 'h33',
    title: '공연 보러 가기',
    description: '공연장의 소리와 분위기를 직접 느끼면 화면으로는 안 되는 생동감이 남아요.',
    category: '제대로',
    isCustom: false,
    creator: 'system',
    totalEnjoyCount: 10
  },
  {
    id: 'h34',
    title: '나만의 취미 만들기',
    description: '잘해야 하는 일 말고 천천히 즐길 취미가 있으면 혼자 있는 시간이 단단해져요.',
    category: '제대로',
    isCustom: false,
    creator: 'system',
    totalEnjoyCount: 7
  },
  {
    id: 'h35',
    title: '하고 싶은 공부 시작하기',
    description: '첫 페이지나 첫 영상만 열어도 나를 위해 움직였다는 뿌듯함이 생겨요.',
    category: '제대로',
    isCustom: false,
    creator: 'system',
    totalEnjoyCount: 6
  },
  {
    id: 'h36',
    title: '방 한쪽 정리하기',
    description: '책상이나 침대 옆만 정리해도 공간과 마음이 함께 가벼워지는 느낌이 들어요.',
    category: '제대로',
    isCustom: false,
    creator: 'system',
    totalEnjoyCount: 9
  },
  {
    id: 'h37',
    title: '혼자 놀기 계획하기',
    description: '내가 먹고 걷고 쉬고 싶은 대로 하루를 짜면 나를 대접하는 기분이 들어요.',
    category: '제대로',
    isCustom: false,
    creator: 'system',
    totalEnjoyCount: 5
  },
  {
    ...
    description: '마음에 남은 문장을 적어두면 나중에 그날의 감정까지 함께 떠올라요.',
    category: '소확행',
    isCustom: false,
    creator: 'system',
    totalEnjoyCount: 4
  },
  {
    id: 'h39',
    title: '옛 사진 보기',
    description: '오래된 사진을 천천히 보면 지나간 순간도 다시 따뜻하게 느껴져요.',
    category: '소확행',
    isCustom: false,
    creator: 'system',
    totalEnjoyCount: 5
  },
  {
    id: 'h40',
    title: '꽃 이름 찾아보기',
    description: '길가의 꽃 이름과 꽃말을 찾아보면 평범한 산책길이 조금 특별해져요.',
    category: '소확행',
    isCustom: false,
    creator: 'system',
    totalEnjoyCount: 3
  },
  {
    id: 'h41',
    title: '소지품에 이름 붙이기',
    description: '자주 쓰는 물건에 이름을 붙이면 평범한 소지품도 더 애틋하게 느껴져요.',
    category: '소확행',
    isCustom: false,
    creator: 'system',
    totalEnjoyCount: 3
  },
  {
    id: 'h42',
    title: '작은 소품으로 방 꾸미기',
    description: '작은 조명이나 엽서 하나만 놓아도 집에 돌아오는 기분이 조금 좋아져요.',
    category: '기분전환',
    isCustom: false,
    creator: 'system',
    totalEnjoyCount: 4
  },
  {
    id: 'h43',
    title: '작은 선물 건네기',
    description: '부담 없는 선물을 건네고 상대가 웃는 모습을 보면 마음이 함께 따뜻해져요.',
    category: '기분전환',
    isCustom: false,
    creator: 'system',
    totalEnjoyCount: 2
  },
  {
    id: 'h44',
    title: '옛 물건 꺼내보기',
    description: '예전에 아끼던 물건을 꺼내면 그때의 내가 떠올라 괜히 반가워요.',
    category: '기분전환',
    isCustom: false,
    creator: 'system',
    totalEnjoyCount: 3
  },
  {
    id: 'h45',
    title: '노래 가사 음미하기',
    description: '익숙한 노래도 가사를 따라 들으면 몰랐던 감정이 새롭게 보여요.',
    category: '기분전환',
    isCustom: false,
    creator: 'system',
    totalEnjoyCount: 4
  },
  {
    id: 'h46',
    title: '평소보다 멀리 걷기',
    description: '한 정거장쯤 더 걸으면 몸의 리듬이 돌아오고 생각도 조금 정리돼요.',
    category: '제대로',
    isCustom: false,
    creator: 'system',
    totalEnjoyCount: 3
  },
  {
    id: 'h47',
    title: '편지 쓰기',
    description: '보내지 않아도 괜찮다는 마음으로 적으면 말로 못 한 감정이 차분해져요.',
    category: '제대로',
    isCustom: false,
    creator: 'system',
    totalEnjoyCount: 2
  },
  {
    id: 'h48',
    title: '생각만 하던 일 시작하기',
    description: '아주 작게라도 시작하면 내가 앞으로 나아가고 있다는 감각이 남아요.',
    category: '제대로',
    isCustom: false,
    creator: 'system',
    totalEnjoyCount: 2
