...
const quickFacts = [
  {
    label: '기록',
    value: '행복을 바로 남기기',
    description: '소확행, 일주일 행복, 한달 행복을 기록하고 나만의 행복 항목도 직접 추가할 수 있습니다.'
  },
  {
    label: '관리',
    value: '즐겨찾기와 메모',
    description: '자주 보고 싶은 행복은 저장하고, 각 항목마다 개인 메모를 남겨 나중에 다시 돌아볼 수 있습니다.'
  },
  {
    label: '루틴',
    value: '꾸준히 이어가는 흐름',
    description: '프로필, 누적 스탬프, 리마인더 설정으로 행복 기록을 일상 루틴처럼 이어갈 수 있습니다.'
  }
];
